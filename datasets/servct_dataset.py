    ...
    def __init__(self,
        ...
        for i, rectified_file in enumerate(self.rectified_files):
            ...
            for seq_image01_path in seq_image01_paths:
                ...
                seq_depth01_path = os.path.join(rectified_file, "Ground_truth_CT", "DepthL", filename)
                seq_depth02_path = os.path.join(rectified_file, "Ground_truth_CT", "DepthR", filename)
...
if __name__ == "__main__":
    ds = SERVCTDataset(data_path='/data1/publicData/SERV-CT', height=256, width=320, frame_idxs=[0], num_scales=4, is_train=False)
    print(ds.scans)